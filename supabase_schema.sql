...
('콜레우스포스콜리', '콜레우스 포스콜리 추출물', '인도 전통 약재식물 추출물로 제지방량(근육량)은 보존하고 체지방을 감소시키는 기능성을 개별인정받은 원료', '콜레우스 포스콜리 포스콜린', 'https://link.coupang.com/a/eA55qNL8eq', 
...
('시서스', '시서스 추출물 (Cissus)', '열대 아시아 자생 식물로 리파아제 활성을 억제하여 식사량 조절 및 체지방 감소 기능성을 인정받은 개별인정형 성분', '시서스 가루 다이어트 캡슐', 'https://link.coupang.com/a/eA57rDuxUW', 
...
('아연', '아연 (Zinc)', '정상적인 면역기능 and 세포분열에 필수적이며 모낭 세포의 성장을 돕고 탈모 완화 영양소 공급에 중요역할을 함', '아연 영양제 징크', 'https://link.coupang.com/a/eA6fl2caya', 
 '8.5 mg', '50 mg (588% 충족)', 
...
('헤마토코쿠스 추출물', '헤마토코쿠스 추출물 (아스타잔틴)', '초강력 항산화 물질로 눈의 피로도 개선에 도움을 줄 수 있음을 식약처가 인정한 기능성 원료', '아스타잔틴 헤마토코쿠스 눈피로', 'https://link.coupang.com/a/eCuO6slpIa',
...
-- 수면 & 스트레스 카테고리 성분
('감태 추출물', '감태 추출물 (디엑콜)', '제주 청정 해역 감태에서 추출한 플로로탄닌 성분으로 수면의 질 개선에 도움을 줄 수 있는 개별인정 원료', '감태추출물 수면 영양제', 'https://link.coupang.com/a/eCuX301KE0',
