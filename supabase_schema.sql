...
('콜레우스포스콜리', '콜레우스 포스콜리 추출물', '인도 전통 약재식물 추출물로 제지방량(근육량)은 보존하고 체지방을 감소시키는 기능성을 개별인정받은 원료', '콜레우스 포스콜리 포스콜린', 
 ...
 '혈압을 낮추는 부작용이 있으므로 저혈압 환자나 항응고제 복용자가 주의가 필요합니다.', 
...
('맥주효모', '건조 맥주효모 (Brewer''s Yeast)', '단백질(아미노산 18종), 비타민 B군, 셀레늄이 풍부하여 모발 및 두피에 영양을 직접 공급하고 모발 건강을 돕는 필수 원료', '국산 맥주효모 환 대용량', 
 ...
 '통풍 기왕력이 있거나 요산 수치가 높아 관절이 자주 붓고 아쁩니다.', NULL,
...
('L-시스틴', 'L-시스틴 (L-Cystine)', '모발 단백질인 케라틴의 구조를 형성하는 황 함유 아미노산으로 가늘어진 모발을 강화하고 끊어짐 방지에 기여함', 'L시스틴 500mg 직구', 
...
-- 눈 건강 카테고리 성분
('루테인지아잔틴', '루테인지아잔틴 복합추출물', '황반색소 밀도를 유지하여 노화로 인한 눈 건강 관리를 돕는 성분으로 식약처 기능성이 인정됨', '루테인지아잔틴 복합추출물 추천',
 '루테인지아잔틴 단일/복합 기준 10~20 mg', '20 mg (100% 충족)',
 '황반색소 밀도를 최대로 유지하여 시각 명료도 유지 및 황반 변성 등 노화 현상 예방에 기여',
 '과다 섭취 시 피부가 일시적으로 황색으로 변할 수 있습니다.',
 '지용성 성분이므로 식사 중 또는 식사 직후 복용해야 흡수가 잘 됩니다.',
 '흡연자이거나 평소 황색 피부 변색 등의 피부 과민 반응이 잦습니다.', NULL,
 '루테인지아잔틴은 카로티노이드 성분으로 장기 고함량 복용 시 흡연자의 폐 질환 발생 위험이나 황색피부증을 유발할 수 있습니다. 대신 눈 피로 해소에 집중하면서 부작용 우려가 적은 헤마토코쿠스 추출물(아스타잔틴)을 추천합니다.'),

('헤마토코쿠스 추출물', '헤마토코쿠스 추출물 (아스타잔틴)', '초강력 항산화 물질로 눈의 피로도 개선에 도움을 줄 수 있음을 식약처가 인정한 기능성 원료', '아스타잔틴 헤마토코쿠스 눈피로',
 '아스타잔틴 기준 4~12 mg', '12 mg (100% 충족)',
 '눈의 초점 조절력 회복을 촉진하고 망막 혈류량을 증가시켜 눈 피로를 완화합니다.',
 '과량 섭취 시 일시적으로 대변 색이 붉게 변하거나 피부가 붉어질 수 있습니다.',
 '지용성이므로 식사 후에 섭취하는 것이 흡수율을 극대화합니다.',
 NULL, NULL, NULL),

-- 혈행 개선 카테고리 성분
('오메가3', '정제어유 (EPA 및 DHA 함유 유지)', '혈중 중성지질 개선 및 혈행 개선에 도움을 줄 수 있는 식약처 고시 필수 불포화지방산', 'rtg 오메가3 고함량',
 'EPA와 DHA의 합 기준 500~2,000 mg', '1,000 mg (200% 충족)',
 '혈액 응고를 억제하여 원활한 혈액 순환 및 중성지질 강하 작용을 돕습니다.',
 ...
 '동물성 오메가3는 어유의 어취와 소화 불량, 혹은 혈액 응고 억제로 인한 멍 발생 등의 부작용을 일으킬 수 있습니다. 대신 냄새가 전혀 없고 미세 혈류를 촉진하는 허브 성분인 은행잎 추출물을 대안으로 권장합니다.'),

('은행잎 추출물', '은행잎 추출물 (플라보놀 배당체)', '혈행 개선 및 기억력 개선에 도움을 줄 수 있음을 식약처가 인정한 대표 허브 원료', '은행잎 추출물 징코 빌로바',
 '플라보놀 배당체 기준 24~36 mg', '36 mg (150% 충족)',
 '말초 혈관을 확장하여 혈액 순환을 개선하고 뇌 혈류량을 늘려 기억력 증진을 도울 수 있습니다.',
 '일시적인 두통, 어지러움, 소화불량 및 출혈 경향이 증가할 수 있습니다.',
 '위장 장애를 줄이기 위해 식후 충분한 물과 섭취하시고, 수술 전후 3~4일 동안은 섭취를 중단하세요.',
 NULL, NULL, NULL),

-- 수면 & 스트레스 카테고리 성분
('감태 추출물', '감태 추출물 (디엑콜)', '제주 청정 해역 감태에서 추출한 플로로탄닌 성분으로 수면의 질 개선에 도움을 줄 수 있는 개별인정 원료', '감태추출물 수면 영양제',
 '디엑콜 기준 30 mg', '30 mg (100% 충족)',
 '자연적인 수면 상태를 유도하고 자다가 깨는 현상과 수면 중 호흡 장애 등을 경감하여 숙면 유지',
...
('락티움', '유청단백가수분해물 (락티움)', '우유 단백질을 미세 분해하여 스트레스로 인한 긴장 완화 및 수면 질 개선에 도움을 주는 성분', '락티움 수면제 대용 추천',
 '알파에스1카제인 기준 2.2~3.2 mg', '300 mg (100% 충족)',
 '스트레스 호르몬인 코르티솔 분비를 조절하고 가바(GABA) 수용체를 활성화하여 깊은 잠 유도',
 ...
 '락티움은 우유 단백질 가수분해물로서 심한 유당불내증이 있는 환자에게 소화기 가스나 설사를 유발할 수 있습니다. 대신 우유 유래 성분이 전혀 없고 뇌파를 이완시켜 긴장 완화에 탁월한 효능을 가진 L-테아닌을 권장합니다.');
...
(6, '수면 & 스트레스', '잠 못 드는 밤과 긴장 이완이 필요한 분들을 위한 맞춤형', 'fa-moon');
...
(6, '혈행 & 순환 밸런스 패키지', '혈액 순환 원활 + 혈중 중성지질 강하', 
 '오메가3가 혈액 응고를 방지하고 중성지질을 낮추어 피의 흐름을 돕고, 은행잎 추출물이 혈관을 확장해 말초까지 골고루 순환을 촉진하는 배가 조합입니다.'),
(7, '딥 슬립 스트레스 릴리프 패키지', '수면 질 개선 + 신경 안정 및 긴장 완화', 
 '락티움이 뇌의 이완과 수면 호르몬 안정을 도와 깊은 잠을 유도하며, L-테아닌이 낮과 밤 동안 쌓인 스트레스로 인한 긴장 상태를 부드럽게 완화해 주는 꿀잠 최적 조합입니다.');
