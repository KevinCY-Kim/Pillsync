...
INSERT INTO ingredients_mapping (id, name, fda_functional_summary, coupang_search_keyword, coupang_tracking_url, kfda_daily_intake, high_dose_ratio, high_dose_effect, side_effects, intake_tip, warning_trigger_text, alternative_ingredient_id, alternative_reason) VALUES
-- 피로 개선 카테고리 성분
('밀크씨슬', '밀크씨슬 추출물 (실리마린)', '실리마린 성분이 간 세포막을 보호하고 항산화 작용을 돕고 피로 회복을 위한 간 건강 기능성을 식약처가 고시함', '밀크씨슬 실리마린 직구', 'https://link.coupang.com/a/eA5jqbcCGq', '실리마린 기준 130 mg', '260 mg (200% 충족)', 
 ...
 '위장이 민감하여 평소 복통이나 설사가 자주 생깁니다.', NULL, '밀크씨슬 추출물은 위와 장을 강하게 자극하여 소화기 통증이나 설사를 일으킬 수 있으므로, 부작용 없이 부신 활력을 회복하는 홍경천 추출물을 안전한 피로 회복 대안으로 추천합니다.'),

('비타민B군', '활성 비타민B 콤플렉스', '수용성 비타민 B1, B2, B6, B12 복합체로 체내 에너지 생성 및 대사에 필수적이며 육체 피로 회복에 도움', '고함량 비타민B 컴플렉스', 'https://link.coupang.com/a/eA5C8k5o9Q', '비타민B1 기준 1.2 mg', '100 mg (8,333% 충족)', 
...
('홍경천 추출물', '홍경천 추출물 (로디올라)', '고산지대 자생 식물로 스트레스로 인한 피로를 개선하는 데 도움을 줄 수 있음을 식약처가 인정한 기능성 원료', '홍경천 로디올라 스트레스', 'https://link.coupang.com/a/eA5HxP9cVo', '로디올라오사이드 기준 200 mg', '200 mg (100% 충족)', 
 '스트레스로 인한 피로 개선 및 가슴 두근거림 완화 효과', 
 '일부 두통 및 어지러움, 혈압에 일시적 변동이 올 수 있습니다.', 
 '오전 또는 오후 섭취가 적당하며, 진정 성분이 있으므로 다른 약물과의 간섭에 주의하세요.',
 NULL, NULL, NULL),

('홍삼', '홍삼 (진세노사이드)', '사포닌(Rg1, Rb1, Rg3) 성분이 함유되어 면역력 증진, 피로 개선, 항산화에 도움을 줄 수 있는 대표 고시형 원료', '홍삼정 에브리타임 스틱', 'https://link.coupang.com/a/eA5Lf855Lo', '진세노사이드 기준 3 mg', '15 mg (500% 충족)', 
 ...
 '고혈압이 있거나 평소 몸에 열이 많고 가슴 두근거림이 잦습니다.', NULL, '홍삼은 혈관을 이완시키나 체질에 따라 교감신경을 흥분시켜 혈압 상승 및 가슴 두근거림을 초래할 수 있습니다. 대신 뇌 세포를 안정시켜 스트레스 긴장을 부드럽게 이완해주는 L-테아닌을 권장합니다.'),

('L-테아닌', 'L-테아닌 (L-Theanine)', '녹차에 들어있는 아미노산의 일종으로 스트레스로 인한 긴장 완화에 도움을 줄 수 있음을 식약처가 인정한 성분', '나우푸드 L테아닌 200mg', 'https://link.coupang.com/a/eA5ObVZpLw', '200~250 mg', '200 mg (100% 충족)', 
...
-- 다이어트 카테고리 성분
('가르시니아', '가르시니아 캄보지아 추출물 (HCA)', '과피 추출물인 HCA가 탄수화물이 지방으로 합성되는 것을 억제하여 체지방 감소에 도움을 주는 고시형 다이어트 원료', '가르시니아 HCA 다이어트', 'https://link.coupang.com/a/eA5ObVZpLw', 'HCA 기준 750~2,800 mg', '1,500 mg (100% 충족)', 
 ...
 '생리 주기가 불규칙하거나 간 기능 우려가 있습니다.', NULL, '가르시니아(HCA)는 드물게 호르몬 균형에 영향을 주어 생리불순이나 간독성을 유발할 수 있습니다. 대신 부작용 없이 체지방을 미토콘드리아로 유입하여 태우는 안전한 대사 촉진 성분인 L-카르니틴을 대안으로 추천합니다.'),

('녹차카테킨', '녹차 추출물 (카테킨)', '카테킨 성분이 항산화 작용을 돕고 체지방 감소 및 혈중 콜레스테롤 수치 개선에 도움을 줄 수 있는 식약처 인증 성분', '녹차카테킨 다이어트보조제', 'https://link.coupang.com/a/eA52o5qJ6y', '카테킨 기준 300~500 mg', '400 mg (100% 충족)', 
 ...
 '카페인에 극도로 예민하여 커피를 마시면 불면증이나 두근거림이 있습니다.', NULL, '녹차카테킨 제품은 녹차 유래 천연 카페인을 소량 함유하고 있어 민감한 분들께 심장 두근거림이나 불면증을 악화시킬 수 있습니다. 대신 천연 무카페인 성분으로 기초 대사를 안전하게 끌어올려주는 콜레우스포스콜리를 적극 권장합니다.'),

('콜레우스포스콜리', '콜레우스 포스콜리 추출물', '인도 전통 약재식물 추출물로 제지방량(근육량)은 보존하고 체지방을 감소시키는 기능성을 개별인정받은 원료', '콜레우스 포스콜리 포스콜린', 'https://link.coupang.com/a/eA55qNL8eq', '포스콜린 기준 50 mg', '50 mg (100% 충족)', 
...
('시서스', '시서스 추출물 (Cissus)', '열대 아시아 자생 식물로 리파아제 활성을 억제하여 식사량 조절 및 체지방 감소 기능성을 인정받은 개별인정형 성분', '시서스 가루 다이어트 캡슐', 'https://link.coupang.com/a/eA57rDuxUW', '시서스 추출물 기준 300 mg', '300 mg (100% 충족)', 
...
('L-카르니틴', 'L-카르니틴 타르트레이트', '체내 지방산을 미토콘드리아로 운반하여 에너지로 연소시키는 과정을 활성화하고 체지방 감소에 도움을 주는 기능성 원료', 'L카르니틴 1000mg 추천', 'https://link.coupang.com/a/eA58XohllI', 'L-카르니틴 타르트레이트 기준 2,000 mg', '2,000 mg (100% 충족)', 
...
-- 탈모 & 모발 건강 카테고리 성분
('비오틴', '비오틴 (Biotin / 비타민B7)', '지방, 탄수화물, 단백질 대사와 에너지 생성에 필수적이며 모발의 주 성분인 케라틴 단백질 합성을 촉진하는 성분', '비오틴 5000mcg 고함량', 'https://link.coupang.com/a/eA6bJ34pa0', '30 mcg', '5,000 mcg (16,666% 충족)', 
 ...
 '지성 피부라 평소 피지 분비가 많고 여드름이나 뾰루지가 잘 납니다.', NULL, '초고함량 비오틴은 지성 피부군에서 피지선을 과자극하여 모낭 트러블이나 뾰루지를 유발할 수 있습니다. 모발 단백질의 핵심 원료 구조를 튼튼하게 강화해주면서 피지 조절을 돕는 L-시스틴을 훌륭한 대안으로 추천합니다.'),

('맥주효모', '건조 맥주효모 (Brewer''s Yeast)', '단백질(아미노산 18종), 비타민 B군, 셀레늄이 풍부하여 모발 및 두피에 영양을 직접 공급하고 모발 건강을 돕는 필수 원료', '국산 맥주효모 환 대용량', 'https://link.coupang.com/a/eA6dOezLMa', '건조 맥주효모 기준 3,000 mg', '3,000 mg (100% 충족)', 
 ...
 '통풍 기왕력이 있거나 요산 수치가 높아 관절이 자주 붓고 아쁩니다.', NULL, '맥주효모는 세포 증식을 돕는 퓨린(Purine) 함량이 극도로 높아 통풍 환자에게 급성 발작을 유발할 수 있습니다. 대신 퓨린 걱정이 전혀 없으면서 두피 모근 세포의 재생과 영양을 채워주는 판토텐산을 안전한 대안으로 권장합니다.'),

('아연', '아연 (Zinc)', '정상적인 면역기능 and 세포분열에 필수적이며 모낭 세포의 성장을 돕고 탈모 완화 영양소 공급에 중요역할을 함', '아연 영양제 징크', 'https://link.coupang.com/a/eA6fl2caya', '8.5 mg', '50 mg (588% 충족)', 
 ...
 '평소 만성 위염이 있거나 속 쓰림, 소화불량 및 메스꺼움을 잘 느낍니다.', NULL, '아연은 위장 점막을 직접적으로 강하게 자극하여 고함량 섭취 시 극심한 메스꺼움이나 쓰림을 유발하기 쉽습니다. 위장에 전혀 부담을 주지 않으면서 천연 아미노산 단백질 공급원이 되는 맥주효모를 대안으로 추천합니다.'),

('L-시스틴', 'L-시스틴 (L-Cystine)', '모발 단백질인 케라틴의 구조를 형성하는 황 함유 아미노산으로 가늘어진 모발을 강화하고 끊어짐 방지에 기여함', 'L시스테인 500mg 직구', 'https://link.coupang.com/a/eA6gX6Bntk', 'L-시스틴 기준 500 mg', '500 mg (100% 충족)', 
...
('판토텐산', '판토텐산 (비타민B5)', '코엔자임 A 합성에 관여하여 세포 재생을 돕고 두피 장벽 강화 및 모근의 탄력과 힘을 개선하는 에너지 대사 영양소', '판토텐산 550mg 추천', 'https://link.coupang.com/a/eA6iR34jNA', '5 mg', '550 mg (11,000% 충족)', 
